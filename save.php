...
// Function to send SMS Notification using SMSONLINEGH API
...
// Function to send SMS via SMSONLINEGH API
function sendSMS($phoneNumber, $message) {
    $api_url = "https://api.smsonlinegh.com/v5/message/sms/send";  // API URL for sending SMS
    $api_key = "dfb6497c1b345eb9dc61b96d3076c557251da34f52178334a51ccb6c61f8df22"; // Your API Key
